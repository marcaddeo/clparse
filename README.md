...
### Debian
```
$ curl -LO https://github.com/marcaddeo/clparse/releases/download/0.4.0/clparse_0.4.0_amd64.deb
$ sudo dpkg -i clparse_0.4.0_amd64.deb
```

### Linux
```
$ curl -LO https://github.com/marcaddeo/clparse/releases/download/0.4.0/clparse-0.4.0-x86_64-unknown-linux-musl.tar.gz
$ tar czvf clparse-0.4.0-x86_64-unknown-linux-musl.tar.gz
